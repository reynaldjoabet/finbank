                ...
                case None    =>
                  ...
                  StubRates
                    ...
                    .orElse(
                      ...
                      StubRates
                        .get((toCurrency.toUpperCase, fromCurrency.toUpperCase))
          ...
          override def validate(lockedRateId: UUID): IO[AppError, LockedRate] =
            for {
              ...
              locked <- ZIO
                ...
                .orElseFail(
                  AppError.NotFound(s"LockedRate $lockedRateId not found")
                )
              _ <- ZIO
                .fail(
                  AppError
                    .Validation("FX rate has expired; please lock a new rate")
                )
