...
final case class UssdSession(
    ...
    context: Map[
      String,
      String
    ], // transient form data collected during the session
    createdAt: Instant,
...
/** A single menu screen rendered to the handset.
  *
  * @param text
  *   The full text to display (max ~160 chars for standard USSD).
  * @param isFinal
  *   If true, this is a terminal message — the session ends.
  */
